...
export default function Account() {
  ...
  const handleSave = (e) => {
    ...
    if (user.Password) {
      axios
        .post(`http://localhost:8082/verify-password`, { email, password: user.Password }) // Assume a backend endpoint to verify password
        .then((response) => {
          ...
          axios
            .put(`http://localhost:8082/edit/${email}`, formData, {
